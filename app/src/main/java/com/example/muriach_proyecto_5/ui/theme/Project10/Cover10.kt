...
@Composable
fun CoverP10(navController: NavController) {
    Column(
    ...
    )
    {
        ...
        Row (Modifier.fillMaxWidth(),
            ...
            Button(
                onClick = { navController.navigate("Exercise45") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Red)
            ) {
                Text(text = "Exercise 45",
                    color = Color.White
                )
            }

            Button(
                onClick = { navController.navigate("Exercise46") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Red)

            ) {
                Text(text = "Exercise 46",
                    color = Color.White
                )
            }
        }
