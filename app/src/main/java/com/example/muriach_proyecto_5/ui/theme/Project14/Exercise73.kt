...
@Composable
fun Exercise73(navController: NavController) {
    Text(
        text = "Welcome to: \n 'PROBLEM N.4'",
    ...
    Column(
        ...
        Button(
            onClick = {
                      textResult = compareNumber(inputNumberA.toDouble(),inputNUmberB.toDouble(),
...
private fun compareNumber(inputNUmberA: Double, inputNUmberB: Double, inputNUmberC: Double) : String {
    ...
    if (inputNUmberA < inputNUmberB && inputNUmberA < inputNUmberC) {
        textResult = "The smallest number is: $inputNUmberA"
    } else if(inputNUmberB < inputNUmberC) {
        textResult = "The smallest number is: $inputNUmberB"
    } else {
        textResult = "The smallest number is: $inputNUmberC"
    }
    return textResult
}
