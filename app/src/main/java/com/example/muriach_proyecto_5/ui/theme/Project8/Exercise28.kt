...
@Composable
fun Exercise28(navController: NavController) {
    Text(
        text = "Welcome to: \n 'PROBLEM N.6'",
    ...
    Column(
        ...
        Row(Modifier.fillMaxWidth()) {
            Text(text = "When you enter the three numbers, " +
                    "the program will tell you if any number is less than 10",
        ...
        Button(
            onClick = {
                if (firstNumber.toInt() < 10 || secondNumber.toInt() <10 ||
                    ...
                    textResult = "Some number is less than 10"
                } else {
                    textResult = "No number is less than 10"
                }
            },
