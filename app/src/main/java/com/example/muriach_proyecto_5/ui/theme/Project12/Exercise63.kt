...
@Composable
fun Exercise63(navController: NavController) {
    Text(
        text = "Welcome to: \n 'PROBLEM N.6'",
    ...
    Column(
        ...
        var quantityNumbers by remember { mutableStateOf(1) }
        var biggestNUmber by remember { mutableStateOf(0) }
        ...
        Button(
            onClick = {
                if (quantityNumbers != 5) {
                    when {
                        inputNumber.toInt() > biggestNUmber -> biggestNUmber = inputNumber.toInt()
                    }
                    quantityNumbers++
                } else {
                    textResult = "The biggest number is: $biggestNUmber"
                }
                inputNumber = ""
            },
