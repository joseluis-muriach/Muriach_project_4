...
@Composable
fun CoverP35(navController: NavController) {
    Column(
    ...
    )
    {
        ...
        Row (Modifier.fillMaxWidth(),
            ...
            Button(
                onClick = { navController.navigate("Exercise145") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Red)
            ) {
                Text(text = "Exercise 145",
                    color = Color.White
                )
            }

            Button(
                onClick = { navController.navigate("Exercise146") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Red)
            ) {
                Text(text = "Exercise 146",
                    color = Color.White
                )
            }
        }
