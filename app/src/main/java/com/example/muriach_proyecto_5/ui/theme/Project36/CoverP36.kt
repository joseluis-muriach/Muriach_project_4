...
@Composable
fun CoverP36(navController: NavController) {
    Column(
    ...
    )
    {
        ...
        Row (Modifier.fillMaxWidth(),
            ...
            Button(
                onClick = { navController.navigate("Exercise147") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Green)
            ) {
                Text(text = "Exercise 147",
                    color = Color.Black
                )
            }

            Button(
                onClick = { navController.navigate("Exercise148") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Green)
            ) {
                Text(text = "Exercise 148",
                    color = Color.Black
                )
            }
        }
