...
@Composable
fun CoverP28(navController: NavController) {
    Column(
    ...
    )
    {
        ...
        Row (Modifier.fillMaxWidth(),
            ...
            Button(
                onClick = { navController.navigate("Exercise125") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Blue)
            ) {
                Text(text = "Exercise 125",
                    color = Color.White
                )
            }
            Button(
                onClick = { navController.navigate("Exercise126") },
                modifier = Modifier.width(200.dp)
                    .padding(5.dp),
                colors = ButtonDefaults.buttonColors(containerColor = Color.Blue)
            ) {
                Text(text = "Exercise 126",
                    color = Color.White
                )
            }
        }
